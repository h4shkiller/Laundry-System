...
<?php  include('card_details_controller.php'); ?>
<?php 
	if (isset($_GET['edit'])) {
		$ID = $_GET['edit'];
		$update = true;
...
<body>
    ...
    <table>
        ...
        <?php while ($row = mysqli_fetch_array($results)) { ?>
            <tr>
                ...
                <td>
                    <a href="card-details.php?edit=<?php echo $row['ID']; ?>" class="edit_btn" >Edit</a>
                </td>
                <td>
                    <a href="card_details_controller.php?del=<?php echo $row['ID']; ?>" class="del_btn">Delete</a>
                </td>
            </tr>
        <?php } ?>
    </table>
	...
	<form method="post" action="card_details_controller.php" >
